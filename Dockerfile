...
RUN sudo apt-get update;  sudo apt-get install -y firefox-esr wget xdg-utils; apt install -y \
    ...
    rm -rf /var/lib/apt/lists/* && wget https://dldir1v6.qq.com/weixin/Universal/Linux/WeChatLinux_x86_64.deb -O wechat.deb; sudo dpkg -i wechat.deb; wget https://dldir1v6.qq.com/qqfile/qq/QQNT/Linux/QQ_3.2.19_250904_amd64_01.deb -O qq.deb; sudo dpkg -i qq.deb;rm *.deb;
